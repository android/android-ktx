...
class ViewGroupTest {
    ...
    @Test fun getOrNull() {
        ...
        assertSame(null, viewGroup.getOrNull(-1))
        assertSame(view1, viewGroup.getOrNull(0))
        assertSame(view2, viewGroup.getOrNull(1))
        assertSame(null, viewGroup.getOrNull(2))
        assertSame(null, viewGroup.getOrNull(3))
    }
